...
create-docs:
	...
	@cp processor/stream/approved-es-documents/testIntakeIntegrationErrors.approved.json docs/data/elasticsearch/generated/errors.json
	@cp processor/stream/approved-es-documents/testIntakeIntegrationTransactions.approved.json docs/data/elasticsearch/generated/transactions.json
	@cp processor/stream/approved-es-documents/testIntakeIntegrationSpans.approved.json docs/data/elasticsearch/generated/spans.json
	@cp processor/stream/approved-es-documents/testIntakeIntegrationMetricsets.approved.json docs/data/elasticsearch/generated/metricsets.json
