...
import (
	...
	"github.com/elastic/apm-server/internal/model/modeldecoder/generator/testdata"
)
...
func generateJSONSchema(t *testing.T, root string) string {
	p := "github.com/elastic/apm-server/internal/model/modeldecoder/generator/testdata"
	parsed, err := Parse(p)
