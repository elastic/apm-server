...
- Introduce `10m` and `60m` aggregation intervals for transaction metrics and store them into dedicated data streams `metrics-apm.transaction.${interval}`, remove transaction metrics from `metrics-apm.interval` {pull}9846[9846]
