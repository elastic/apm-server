...
- Fall back to system memory if cgroup exceeds the available memory {pull}9881[9881]
- Fix servicemetrics aggregator name typo {pull}10022[10022]
- Disable strict permission checks in Docker {pull}9818[9818]
...
- Adapt to Elastic Agent v2 protocol changes {pull}9544[9544]
- Add 'fleet' activation method to the Java attacher {pull}9803[9803]
