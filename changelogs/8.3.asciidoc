...
- Limit the number of gomaxprocs when CPU limits have been set within a cgroup, which yield significant improvements, particularly when the APM Server experiences high traffic from a high number of APM agents {pull}8175[8175] {pull}8278[8278]
