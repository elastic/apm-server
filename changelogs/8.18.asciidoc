...
- APM Integration on ECH or ECE uses recommended frozen values for infrastructure related configs. The fix is applied through https://github.com/elastic/kibana/issues/234384[kibana#234384].
