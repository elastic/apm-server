...
- Fixed HTTP/2 connections being dropped by strict clients and browser-based RUM agents due to APM Server sending inconsistent SETTINGS frames at connection start. ({pull}20913[20913])
For more details, please refer to our https://www.elastic.co/docs/release-notes/apm/known-issues[known issues]
