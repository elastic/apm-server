...
[float]
==== Bug fixes
- Fix the <<known-issue-13031,known issue>> introduced in version `7.17.20` causing failure in APM-server startup due to failure to bootstrap the fleet-server.
