		...
		"overwrite default": {
			inpCfg: map[string]interface{}{
				...
				"authorization": map[string]interface{}{
					"bearer": map[string]interface{}{"token": "1234"},
					"api_key": map[string]interface{}{
						"enabled":       true,
						"elasticsearch": map[string]interface{}{"hosts": []string{"127.0.0.1:9200"}},
						"cache":         map[string]interface{}{"expiration": "30s", "size": 50},
					},
				},
				...
				AuthConfig: &AuthConfig{
					...
					APIKeyConfig: &APIKeyConfig{
						...
						ESConfig: &elasticsearch.Config{
							Hosts: elasticsearch.Hosts{"127.0.0.1:9200"}, Timeout: 10 * time.Second, Protocol: "http"},
						Cache: &LimitedCache{Expiration: 30 * time.Second, Size: 50},
					},
				},
			...
			outCfg: &Config{
				...
				AuthConfig: &AuthConfig{
					...
					APIKeyConfig: &APIKeyConfig{
						...
						ESConfig: defaultAuthConfig().APIKeyConfig.ESConfig,
					},
				},
				TLS: &tlscommon.ServerConfig{
					Enabled:     &truthy,
