...
type Map struct {
	Required  map[string]any       `json:"required" validate:"required,inputTypesVals=string;bool;number,maxLengthVals=5,patternKeys=patternB"`
	Nullable  map[string]any       `json:"nullable"`
