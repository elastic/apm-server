...
import (
	...
	"github.com/elastic/apm-data/input/elasticapm/internal/modeldecoder/generator/testdata"
)
...
func generateJSONSchema(t *testing.T, root string) string {
	p := "github.com/elastic/apm-data/input/elasticapm/internal/modeldecoder/generator/testdata"
	parsed, err := Parse(p)
