...
<<<<<<< HEAD
	...
	github.com/elastic/beats/v7 v7.0.0-alpha2.0.20240717115527-8af2d57dac1c
...
>>>>>>> 53067a6ac (build(deps): bump github.com/elastic/apm-data from 1.8.4 to 1.9.0 (#13725))
