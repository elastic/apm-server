...
require (
	...
	github.com/elastic/beats/v7 v7.0.0-alpha2.0.20251001122104-75793bc8036f
...
>>>>>>> ce17c49d (build(deps): bump google.golang.org/protobuf from 1.36.9 to 1.36.10 (#18896))
)
