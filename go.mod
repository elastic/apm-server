...
<<<<<<< HEAD
	github.com/elastic/beats/v7 v7.0.0-alpha2.0.20221118111442-cd547c688521
=======
	github.com/elastic/beats/v7 v7.0.0-alpha2.0.20221129031800-f74ba6910618
	github.com/elastic/elastic-agent-client/v7 v7.0.2-0.20221129150247-15881a8e64ef
>>>>>>> dab29cec (Updated elastic-agent-client to v7.0.2-0.20221129150247-15881a8e64ef (#9691))
