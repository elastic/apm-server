...
require (
	...
	github.com/elastic/beats/v7 v7.0.0-alpha2.0.20220803193158-494eac104ab0
...
require (
	...
	github.com/elastic/elastic-agent-client/v7 v7.0.0-20220803131543-0c8804bd454c // indirect
