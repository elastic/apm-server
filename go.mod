...
<<<<<<< HEAD
	...
	github.com/elastic/beats/v7 v7.0.0-alpha2.0.20240801124525-a70fd7dd87ef
...
>>>>>>> 9c7d46861 (build(deps): bump github.com/elastic/apm-aggregation from 1.0.1 to 1.0.2 (#13822))
