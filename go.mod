...
require (
	...
	github.com/elastic/beats/v7 v7.0.0-alpha2.0.20251009133902-dfaa95b8cde3
...
>>>>>>> 2abdae32 (build(deps): bump golang.org/x/net from 0.45.0 to 0.46.0 in the golang-org-x group (#19046))
