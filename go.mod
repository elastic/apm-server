...
require (
	...
	github.com/elastic/beats/v7 v7.0.0-alpha2.0.20240319090818-4a86c6431448
...
>>>>>>> a7c427276 (build(deps): bump google.golang.org/protobuf from 1.32.0 to 1.33.0 (#12787))
