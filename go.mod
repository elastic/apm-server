...
require (
	...
	github.com/elastic/beats/v7 v7.0.0-alpha2.0.20241217141043-a15c7ff733f3
...
>>>>>>> 98d405e5 (build(deps): bump go.opentelemetry.io/collector/pdata from 1.21.0 to 1.22.0 in the otel group (#14986))
