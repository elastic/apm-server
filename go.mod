...
>>>>>>> cba4789c (build(deps): bump github.com/KimMachineGun/automemlimit from 0.7.4 to 0.7.5 (#19304))
	...
	github.com/elastic/beats/v7 v7.0.0-alpha2.0.20251023114217-52d36999caff
