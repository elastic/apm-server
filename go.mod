...
<<<<<<< HEAD
	...
	github.com/elastic/beats/v7 v7.0.0-alpha2.0.20230627063025-bef2c2b7c3d7
=======
	github.com/elastic/apm-data v0.1.1-0.20230628080651-9f67b9cdd993
	github.com/elastic/beats/v7 v7.0.0-alpha2.0.20230627095719-e16de717459e
>>>>>>> 2a84bcf3 (build: bump apm-data for performance work (#11084))
