...
require (
	...
	github.com/elastic/beats/v7 v7.0.0-alpha2.0.20220905080641-a700362fcb04
...
require (
	...
	github.com/elastic/elastic-agent-client/v7 v7.0.0-20220905112629-48ba9b7d52db // indirect
