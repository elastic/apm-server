...
func (m *metadataNoKey) IsSet() bool {
	return m.Metadata.IsSet()
}

func (m *metadataNoKey) Reset() {
	m.Metadata.Reset()
}

func (m *metadataNoKey) validate() error {
...
func (m *metadata) validate() error {
	...
	for k, v := range m.Labels {
		...
		case json.Number:
		default:
			return fmt.Errorf("validation rule 'typesVals(string;bool;number)' violated for 'metadata.labels' for key " + k)
		}
	}
