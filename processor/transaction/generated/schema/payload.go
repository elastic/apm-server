...
const PayloadSchema = `{
  ...
  "required": ["pid"]
    ...
    "properties": {
        ...
        {
            "oneOf": [
                {     "$id": "docs/spec/transactions/single_service_tracing.json",
    "description": "Ids and relations for transactions according to deprecated concept used for single service tracing",
                            ...
                            "spans": {
                                ...
                                "items": {
                                    "allOf": [
                                        ...
                                        {     "$id": "docs/spec/transactions/span_common.json",
    ...
    "required": ["duration", "name", "start", "type"] }
                    ...
                    {     "$id": "docs/spec/transactions/transaction_common.json",
    ...
    "properties": {
        "transactions": {
            ...
            "items": {
                "allOf": [
                    { 
                          "$id": "docs/spec/distributed_tracing.json",
    "description": "Ids and relations according to distributed tracing concept",
