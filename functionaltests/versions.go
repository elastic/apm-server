...
func NewVersionsCache(ctx context.Context, ecc *ecclient.Client, ecRegion string) (*Cache, error) {
...
func (c *Cache) GetLatestSnapshot(t *testing.T, prefix string) ecclient.StackVersionInfo {
	t.Helper()
...
func (c *Cache) GetLatestVersionOrSkip(t *testing.T, prefix string) ecclient.StackVersionInfo {
	t.Helper()
...
// If the version is not found, the test is skipped.
func (c *Cache) GetLatestBCOrSkip(t *testing.T, prefix string) ecclient.StackVersionInfo {
	t.Helper()
