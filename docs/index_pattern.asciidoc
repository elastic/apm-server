...
NOTE: Changing the default index pattern will break the Kibana UI and dashboards. We intend to add support for custom index patterns in future versions of the Kibana UI.
