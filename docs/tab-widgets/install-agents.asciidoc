...
* {apm-go-ref-v}/instrumenting-source.html[Detailed guide to instrumenting Go source code]
// end::go[]
...
Add the the agent package(s) from https://www.nuget.org/packages?q=Elastic.apm[NuGet] to your .NET application.
