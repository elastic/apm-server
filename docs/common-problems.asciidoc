...
* Java Agent - {apm-java-ref}/config-reporter.html#config-max-queue-size[`max_queue_size`]
* Node.js Agent - No internal queue. Data is lost
* Python Agent - {apm-py-ref}/tuning-and-overhead.html#tuning-queue[Transaction Queue]
* Ruby Agent - {apm-ruby-ref}/configuration.html#config-api-buffer-size[`api_buffer_size`]
* RUM Agent - ?
// * .NET Agent - 