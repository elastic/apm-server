...
[float]
==== Transaction
A transaction must meet the schema requirements for either `single service tracing` or `distributed tracing`.

* <<transaction-single-service-tracing-schema>>
* <<transaction-distributed-tracing-schema>>
* <<transaction-common-transaction-schema>>
* <<transaction-common-span-schema>>
* <<transaction-stacktraceframe-schema>>
* <<transaction-marks-schema>>
...
[[transaction-single-service-tracing-schema]]
[float]
===== Single Service Tracing Specificas

[source,json]
----
include::./spec/transactions/single_service_tracing.json[]
----

[[transaction-distributed-tracing-schema]]
[float]
===== Distributed Tracing Specificas

[source,json]
----
include::./spec/transactions/distributed_tracing.json[]
----

[source,json]
----
include::./spec/transactions/distributed_tracing_relations.json[]
----
...
[source,json]
----
include::./spec/transactions/transaction_common.json[]
----
...
[source,json]
----
include::./spec/transactions/span_common.json[]
----
...
[source,json]
----
include::./spec/transactions/mark.json[]
----
