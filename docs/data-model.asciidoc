...
the max transaction group limit is reached for a service that has 100 instances and 40 different transaction names when
connected to an APM Server with 8GB of RAM. Once this limit is reached, any new combinations of `transaction.name` and
