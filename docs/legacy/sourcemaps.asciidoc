...
=======
>>>>>>> 1059458e (docs: update source map docs for 8.0 (#6927))
...
That's it! New exception stack traces should now be correctly mapped to your source code.
Don't forget to enable RUM support in the APM integration if you haven't already.
