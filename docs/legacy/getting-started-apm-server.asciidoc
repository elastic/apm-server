...
== Get started with APM Server (self managed)

++++
<titleabbrev>Get started (Self managed)</titleabbrev>
++++
...
[role="screenshot"]
image::./guide/images/kibana-apm-sample-data.png[{apm-app} with data]
