...
available when you enable {security-features} (see
{ref}/secure-cluster.html[Secure a cluster] and <<securing-{beatname_lc}>>).
If you aren't using {security-features}, you can use a web proxy instead.
