...
NOTE: Asynchronous processing has weaker guarantees since content validation errors
cannot be communicated back to the client and may be more difficult to uncover,
instead, requests resulting in an error will be logged by the APM Server.
