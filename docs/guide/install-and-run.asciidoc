...
NOTE: The following links assume you're using the current version of the Elasticstack. If you're not, it's easy to adjust the version of the documentation after you land on each page.
...
// todo: determine best location for this section
...
Just like that, you're up and running with Elastic APM. Check out the <<doc-directory,documentation directory>> for ideas on where to go from here. 


// todo: REMOVED IDs
// [[more-information]] -> FWD to apm-server
// [[secure-api-access]] -> FWD to apm-server

// todo: is kibana ss necessary?
