...
There are two ways to install Elastic APM: Using our hosted Elasticsearch Service,
or by installing the stack yourself.
...
image::install_apm_cloud.png[Install Elastic APM on Cloud]
...
image::install_apm_yourself.png[Install Elastic APM yourself]
