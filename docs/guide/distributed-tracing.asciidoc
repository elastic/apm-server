...
If your service communicates over an unsupported protocol, like TCP, UDP, WebSocket,
you can manually propagate distributed tracing context from the sending service to the receiving service
with the agent's API.
