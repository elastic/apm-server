...
Finally, {ref}/set-processor.html[set] the value of the new `body.original_json` field to `"redacted"`–again,
only if the new `body.original_json` field was created:
