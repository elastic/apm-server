...
[role="screenshot"]
image::images/breakdown-release-notes.jpg[Aggregate Service Breakdown Charts]
...
[role="screenshot"]
image::images/remote-config-release-notes.jpg[APM Agent configuration]
...
[role="screenshot"]
image::images/jvm-release-notes.jpg[JVM instance level visibility]
