...
* {kibana-ref}/filters.html#local-filters[Structured filters]:
...
* {apm-overview-v}/observability-integrations.html[Log integration]:
...
* {apm-agent-dotnet}/supported-technologies.html[.NET agent full framework support]:
