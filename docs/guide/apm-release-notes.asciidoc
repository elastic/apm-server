...
APM now supports {apm-get-started-ref}/distributed-tracing.html[distributed tracing].

*APM Server*
* Allow to register and apply pipelines when ingesting documents.
* Add apm-server monitoring.
* Add Intake Protocol v2 with distributed tracing support
