...
Install Elastic Agent and enable Fleet Server on your edge machines
...
Use the Fleet UI to push configuration changes and upgrades, and to add other integrations
