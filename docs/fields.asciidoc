...
The hex encoded ID of the transaction, unique per trace.
...
Deprecated (>= 6.4). A UUID4 transaction ID. 
...
The hex encoded ID of the error, unique per trace.
...
Deprecated (>= 6.4). A UUID for the error.
...
The ID of the parent transaction or span, unique per trace.
...
The UUID of the corresponding trace.
...
Sampled metrics collected from the agent
...
Deprecated (>= 6.4). A locally unique ID of the span.
...
The hex encoded ID of the span, unique per trace.
...
Deprecated (>= 6.4). The locally unique ID of the parent of the span.
