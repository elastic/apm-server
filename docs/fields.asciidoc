...
+
--
Aggregated transaction durations, excluding the durations where a direct child was running, in microseconds.
...
+
--
Aggregated span durations, excluding the durations where a direct child was running, in microseconds.
