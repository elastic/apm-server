...
+
--
Type of the destination service (e.g. 'db', 'elasticsearch'). Should typically be the same as span.type. This field is DEPRECATED and it will be removed in a future release
...
+
--
Identifier for the destination service (e.g. 'http://elastic.co', 'elasticsearch', 'rabbitmq') This field is DEPRECATED and it will be removed in a future release
