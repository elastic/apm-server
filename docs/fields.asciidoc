...
+
--
Type of the messaging system for which the event was recorded
...
+
--
Name of the message queue where the message is published or received.
...
+
--
Topic name used for routing the message.
...
+
--
Message operation, e.g. 'send' or 'receive'.
