...
* <<manual-ilm-setup,Manual index lifecycle management>>
...
you can delete data periodically with <<manual-ilm-setup,index lifecycle management>>,
{curator-ref-current}[Curator], by using the {ref}/docs-delete-by-query.html[Delete By Query API],
...
Learn more in <<manual-ilm-setup,manual index lifecycle management>>.
