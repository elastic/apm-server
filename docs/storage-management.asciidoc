...
[partintro]
--
There are a view options how you can manage your APM data in Elasticsearch.

In the following we focus on how you can 

* <<manage-indices-kibana, manage indices via Kibana>>
...
Select the indices you want to delete, then click the _Manage n indices_ button to see supported options.
