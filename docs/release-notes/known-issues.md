...
APM Integration, which is APM Server managed by Fleet, might sometimes be unreachable after reloading due to an integration policy change. This does not affect standalone APM Server.
