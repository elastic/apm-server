...
In this case, you'll need to disable the active output and point APM Server at your Elasticsearch cluster.
You can then run the `setup --pipeline` command to register the pipeline definitions in `definition.json`.
