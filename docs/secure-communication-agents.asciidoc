...
In certain use cases, like when the RUM agent runs in end users' browsers,
authentication isn't possible. See <<configuration-anonymous>> to configure unauthenticated,
but rate-limited communication between APM agents and Server.
