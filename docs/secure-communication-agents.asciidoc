  ...
  "role_descriptors": {
    "apm": {
      "applications": [
        {
          "application": "apm",
          "privileges": ["sourcemap:write", "event:write", "config_agent:read"], <2>
          "resources": ["*"]
        }
      ]
    }
...
Using the returned string, you can verify the API key has the expected privileges with the APM Server CLI:
