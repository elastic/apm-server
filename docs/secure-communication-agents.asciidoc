...
Here's a basic output config with secure communication enabled:
...
This allows you to enable encryption and verify that you are sending data to the correct APM Server.
