...
* *PHP agent*: {apm-php-ref}/configuration-reference.html#config-api-key[`api_key`]
...
* *PHP agent*: {apm-php-ref}/configuration-reference.html#config-secret-token[`secret_token`]
...
* *PHP agent*: {apm-php-ref}/configuration-reference.html#config-server-url[`server_url`]
* *Python agent*: {apm-py-ref}/configuration.html#config-server-url[`server_url`]
