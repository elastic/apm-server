...
In addition, if you're creating an API key from the APM app,
...
----
<1> The privileges added in this object only apply to roles that will create API keys in the APM app.
If you don't have access to the APM app, you can omit this object and skip to <<create-an-api-key-alternate>>.
...
If you don't have access to the APM app, API keys can be created in {kib} Stack Management.
