...
This default pipeline calls a non-existent and non-versioned "`@custom`" ingest pipeline.
...
* _link coming soon_ — A simple Elastic integration tutorial where you learn how to add a custom field to incoming data.
