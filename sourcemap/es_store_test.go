...
func newMockElasticsearchClient(t testing.TB, statusCode int, responseBody io.Reader) elasticsearch.Client {
	return newHandlerFuncElasticsearchClient(t, func(w http.ResponseWriter, r *http.Request) {
		if r.URL.Path == "/" {
...
func newHandlerFuncElasticsearchClient(t testing.TB, h http.HandlerFunc) elasticsearch.Client {
