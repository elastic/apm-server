...
module "benchmark_worker" {
  ...
  apm_server_url   = module.standalone_apm_server.apm_server_url
  apm_secret_token = module.standalone_apm_server.apm_secret_token
...
module "moxy" {
  ...
  instance_type = var.moxy_instance_type
