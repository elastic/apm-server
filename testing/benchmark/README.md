...
### Slack reporting
Reporting data is taken from the [app_bench_diff_shifts_slack](https://observability-benchmarks.elastic.dev/app/dashboards#/view/a5bc8390-2f8e-11ed-a369-052d8245fa04?_g=(filters:!(),refreshInterval:(pause:!t,value:0),time:(from:now-30d,to:now)))
